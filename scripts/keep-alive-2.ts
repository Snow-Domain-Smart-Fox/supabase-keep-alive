...
// 从环境变量获取 Supabase 配置
const supabaseUrl = 'https://tlsufwwanzgacsngbogh.supabase.co';
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRsc3Vmd3dhbnpnYWNzbmdib2doIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzIxNzQ1MDAsImV4cCI6MjA4Nzc1MDUwMH0.A9Z2VhQrSykJcLwXZYkUOArzbt-s4EnUsWtAFfyy-yI';
